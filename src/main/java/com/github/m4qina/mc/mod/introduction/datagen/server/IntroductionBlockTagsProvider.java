...
public class IntroductionBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(IntroductionBlocks.ORIHALCON_BLOCK.get());
        this.tag(Tags.Blocks.NEEDS_NETHERITE_TOOL).add(IntroductionBlocks.RAW_ORIHALCON_BLOCK.get());
    }
}
